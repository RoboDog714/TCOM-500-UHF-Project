...
To recreate this, the Docker container included in this repo can be cloned onto a RP5 and unpacked, which should install all necessary pieces of software and their dependencies.  IT IS IMPORTANT THAT WHILE THE DOCKER CONTAINER IS DEPLOYED THAT THE SDR IS NOT PLUGGED IN.  ONLY PLUG THE SDR INTO THE RP5 AFTER THE FULL DEPLOYMENT OF THE DOCKER CONTAINER.  As of this point in time, the Docker container does not contain the finished ATSC.GRC files, however they can be found in the GNU Radio GRCs folder of this repo.
